...
import BenefitsComponent from "./home/components/Benefits.component"
    ...
    return (
        <div className="flex flex-col ">
            ...
            <section className="mt-28 px-6">
                <h1 className="my-5 text-3xl font-semibold">Categories</h1>
                <div className="grid grid-cols-2 gap-4 md:grid-cols-4">
